...
source_path = 'data/deeplearning_data/adjacent_labels/all_para/'
des_path = 'data/baseline_data/adjacent_labels/all_para/'
train_title_label_file = source_path + 'train_title_label.pkl'
test_title_label_file = source_path + 'test_title_label.pkl'
train_title_feature_file = source_path + 'train_title_feature.pkl'
test_title_feature_file = source_path + 'test_title_feature.pkl'

train_title_label = load_pickle(train_title_label_file)
test_title_label = load_pickle(test_title_label_file)
train_title_feature = load_pickle(train_title_feature_file)
test_title_feature = load_pickle(test_title_feature_file)
...
labels = np.unique(np.concatenate(train_title_label.values())).tolist()
...
# train
train_pids = train_title_label.keys()
...
for pid in train_pids:
    ...
    # add features
    l_str = l_str + train_title_feature[pid]
    train_label_feature_file.write(l_str)

test_pids = test_title_label.keys()
...
for pid in test_pids:
    ...
    l = test_title_label[pid]
    l_str = ''
    for l_i in l[:-1]:
        l_str = l_str + str(label_dict[l_i]) + ','
    l_str = l_str + str(label_dict[l[-1]]) + ' '
    # add features
    l_str = l_str + test_title_feature[pid]
